...
)
{
    ...
    */
    ...
    fh_stdin->fh_Type  = (struct MsgPort *) &emulbase->eb_device;
    fh_stdin->fh_Arg1  =                    emulbase->eb_stdin;

    fh_stdout->fh_Type = (struct MsgPort *) &emulbase->eb_device;
    fh_stdout->fh_Arg1 =                    emulbase->eb_stdout;
